export default function StatsCTA() {
    ...
    return (
        <section
            ...
            {/* Content */}
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between py-6 px-6 gap-6" style={{
                backgroundImage: "url('/backgroundImage.png')", // replace with your local background path
